...
public class OlympicsMedals2016 {
	...
	public void silverCountriesMedal() {
		...
		System.out.println("List of countries whose silver medal count is equal to 18 = "
				+ getCountryByMedalCount(countryList, SilverMedalsList, 18));
			...
			for (int j = 0; j < BronzMedalsList.size(); j++) {
				...
				if (Integer.parseInt(BronzMedalsList.get(i).getText())
					...
					if (countryList.get(i).getText().equals(countryList.get(j).getText())) {
						...
						System.out.println("List of two countries whose sum of bronze medals is 18 = [" + firstCountry
								+ "-" + SecondCountry + "]");
						break;
